 ...
 */
struct prjm_eel_code;

/**
 * @brief Buffer pointer for megabuf/gmegabuf memory.
 */
typedef PRJM_EEL_F** prjm_eel_mem_buffer;
 ...
 * @return A handle to a buffer which can be passed to @a pjrm_eel_context_create().
 */
prjm_eel_mem_buffer prjm_eel_memory_buffer_create();
 ...
 */
struct prjm_eel_context* pjrm_eel_context_create(prjm_eel_mem_buffer global_mem);
 ...
 * @note This will not destroy any remaining code handles. Call @a pjrm_eel_code_destroy() on each handle separately.
 * @param ctx The context to destroy.
 */
void pjrm_eel_context_destroy(struct prjm_eel_context* ctx);
 ...
 */
void pjrm_eel_context_free_memory(struct prjm_eel_context* ctx);
 ...
 */
void pjrm_eel_context_reset_variables(struct prjm_eel_context* ctx);
 ...
 */
PRJM_EEL_F* pjrm_eel_context_register_variable(struct prjm_eel_context* ctx, const char* var_name);

/**
 * @brief Compiled the given code into an executable program.
 * Call @a prjm_eel_get_error() to retrieve the compiler error and location on compilation failure.
 ...
 */
struct prjm_eel_code* pjrm_eel_code_compile(struct prjm_eel_context* ctx, const char* code);
 ...
 */
void pjrm_eel_code_destroy(struct prjm_eel_code* code_handle);
 ...
 */
PRJM_EEL_F pjrm_eel_code_execute(struct prjm_eel_code* code_handle);
 ...
 */
const char* prjm_eel_get_error(struct prjm_eel_context* ctx, int* line, int* column);
